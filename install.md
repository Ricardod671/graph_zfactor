# graph_zfactor guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `graph_zfactor/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `graph_zfactor` folder and use the modules inside your notebooks :
...
```python
from graph_zfactor.utils.paths import data_dir
data_dir()
```
